...
- `process` performs the asynchronous work and applies revision instructions.
...
The channel also marks when the Flow is actually awaiting feedback, preventing
an early or duplicate HTTP decision from being consumed by a later review.
