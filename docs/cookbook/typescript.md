...
| [Concurrent Service Checks](https://github.com/skadaai/caskada/tree/main/cookbook/typescript-batch)        |        5.5 | Fan-out, local concurrency, `end(value)`, and `combine`    |
| [Partial Batch Recovery](https://github.com/skadaai/caskada/tree/main/cookbook/typescript-resilient-batch) |          6 | Flow recovery with settled branch terminals                |

Every project runs its real Caskada graph in cookbook verification. External
