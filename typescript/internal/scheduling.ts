...
import type { CompiledPlacement, CompiledScope, CompiledSnapshot } from './definition.js'

const missing = Symbol('missing')

class InvalidOutcome extends Error {}
...
class CallbackContext<State extends object> implements Context<State> {
