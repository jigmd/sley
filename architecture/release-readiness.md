...
| ----------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Identity                | Pass   | Product, imports, package metadata, repository links, tooling, and examples use Sley / `sley`; the predecessor name appears only in migration context. |
